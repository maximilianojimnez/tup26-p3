# Examen final: Agenda de contactos
...
Para rendir el examen final, el alumno deberá desarrollar, presentar y defender una aplicación web funcional que cumpla con los requisitos descriptos en este documento.
...
- Modificar contactos.
- Eliminar contactos.
- Registrar comunicaciones asociadas a cada contacto, tales como llamadas, correos electrónicos, mensajes o reuniones.
...
### 2.1. Ejemplo visual del resultado

La siguiente imagen muestra un ejemplo orientativo de cómo podría verse la aplicación terminada:

![Ejemplo de pantalla principal, edición de contacto y edición de comunicación de la agenda de contactos](examen-final.jpg)
...
| Referencia al contacto | Obligatoria |
...
- Si existen contactos cargados, debe quedar seleccionado automáticamente el primer contacto de la lista.
...
| Contacto | Apellido | Obligatorio |
| Contacto | Correo electrónico | Formato válido, si se ingresa |
| Comunicación | Tipo | Obligatorio |
| Comunicación | Descripción | Obligatoria |
| Comunicación | Fecha y hora | Obligatoria |
| Comunicación | Fecha y hora | No puede ser futura |
