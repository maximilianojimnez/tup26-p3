...
class Pruebas
{
    public static void Ejecutar()
    {
        ...
        Probar(ref numero, "Prioridad de operadores y paréntesis", () =>
        {
            AfirmarEvaluacion("2 + 3 * 4", 0, 14);
            AfirmarEvaluacion("(2 + 3) * 4", 0, 20);
            AfirmarEvaluacion("20 / 2 / 2", 0, 5);
            AfirmarEvaluacion("10 - 3 - 2", 0, 5);
            AfirmarEvaluacion("x", 8, 8);
            AfirmarEvaluacion("X", 8, 8);
            AfirmarEvaluacion(" 1 + 2 ", 0, 3);
        });
        ...
        Probar(ref numero, "Errores de parsing del enunciado", () =>
        {
            ...
            AfirmarExcepcion<FormatException>(() => Compilador.Parse("1 +"), "Token inesperado", "operador sin segundo término");
            AfirmarExcepcion<FormatException>(() => Compilador.Parse("()"), "Token inesperado", "paréntesis vacío");
        });
